...
--
-- Host: localhost
-- Generation Time: Jul 04, 2024 at 04:36 AM
...
INSERT INTO `listings` (`listing_id`, `title`, `price`, `user_id`, `phone`, `email`, `description`, `image`, `approved`) VALUES
(10128, 'bulldog', '123', 12, '555444', '0', '', 'uploads/english-bulldog-562723_1280.jpg', 0),
(10130, 'PAS123', '500', 23, '1231231231', '0', '', 'uploads/jrdog1.jpg', 0),
(10138, 'Bulldog', '500', 12, '13121312', '0', '', 'uploads/bulldog1.jpg', 0),
(10151, 'Chihuahua', '450', 23, '1231231231', '0', 'The Chihuahua is a balanced, graceful dog of terrier-like demeanor, weighing no more than 6 pounds. The rounded \"apple\" head is a breed hallmark. The erect ears and full, luminous eyes are acutely expressive. Coats come in many colors and patterns, and can be long or short.', 'uploads/chihuahua-466236_1280.jpg', 0),
(10152, 'Pug', '500', 23, '1231231231', '0', 'Pug, breed of toy dog that probably originated in China and was introduced to England near the end of the 17th century by Dutch traders. The Pug has a short muzzle and a tightly curled tail. It is a squarely built muscular dog with a large head, prominent dark eyes, and small drooping ears', 'uploads/dog-123722_1280.jpg', 0),
(10153, 'Laske', '50', 23, '1231231231', '0', 'Matija Lazić, jedan od najtraženijih i najuspešnijih sportskih tipstera na Balkanu. Izgradio sam izuzetnu karijeru i ulged u poslednjih godinu dana i stekao ogromno bogatstvo. Nastojim i razumem da mnogi nemaju puno poverenje i skeptični su da povere nekom iznos članarine kako bi ih on savetovao na koje događaje i koliki procenat budžeta treba ulagati.', 'uploads/laskedomperignon.png', 0),
(10158, 'Pug', '500', 23, '1231231231', 'd@d', 'Pug is dog!', 'uploads/pug-600907_1280.jpg', 0);
...
(15, 'Nikola', 'Virus', 'n@n', '$2y$10$oxEx77TKWuhNGpssNnYZSeV6il.YRGnAVNm0zijJl5SBsv6fN7Q2G', '', 'user', 0, 1, NULL),
...
--
ALTER TABLE `breeds`
  MODIFY `breed_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
...
--
ALTER TABLE `listings`
  MODIFY `listing_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10159;

--
-- AUTO_INCREMENT for table `listings1`
--
ALTER TABLE `listings1`
  MODIFY `listing_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
